  ...
  ui = shiny::fluidPage(
    shiny::sidebarLayout(
      shiny::sidebarPanel(width = 2, style = "margin: 10px; overflow-y:scroll; max-height: 10%; font-size:14px",
        ...
        shiny::sliderInput(inputId = "bndsRate" ,       label = "bndsRate" ,       min =     0,    max =      1,  value =      0,   ticks = FALSE, step = 0.01, width = 200),
        shiny::sliderInput(inputId = "bndsSaturation",  label = "bndsSaturation",  min =     0,    max =    500,  value =      0,   ticks = FALSE, step =    1, width = 200),

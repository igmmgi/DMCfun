  ...
  ui = shiny::fluidPage(
    shiny::sidebarLayout(
      shiny::sidebarPanel(width = 2, style = "margin: 20px; overflow-y:scroll; max-height: 100%; font-size:18px",
        ...
        shiny::sliderInput(inputId = "bnds_rate",       label = "bnds_rate",       min =     0,    max =   1,     value =      0,   ticks = FALSE, step = 0.01, width = 250),
        shiny::sliderInput(inputId = "bnds_saturation", label = "bnds_saturation", min =     0,    max = 500,     value =      0,   ticks = FALSE, step =    1, width = 250),
